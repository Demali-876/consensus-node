...
// ---------------------------------------------------------------------------
// Bug: integerParam coerces null / false / "" to 0 via Number(), passes the
// Number.isInteger(0) === true check, and returns Math.max(min, 0) = min
// instead of the fallback.  On unfixed code every assertion below would fail.
// ---------------------------------------------------------------------------
